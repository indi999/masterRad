                                            ...
                                            <tr>
                                                ...
                                                <td scope="row">{{$task->expected_date_end}}</td>
                                                    ...
                                                    @foreach($task->departments as $department)
                                                           ...
                                                           @if($department->name == "DIZAJN/PRIPREMA")
                                                                 <td scope="row" class="active">{{$department->name}} - {{$department->pivot->status}}<i class="fa fa-calendar"
                                                            ...
                                                            @if($department->name == "PRODUKCIJA")
                                                                 <td scope="row" class="active">{{$department->name}} - {{$department->pivot->status}}<i class="fa fa-calendar"
                                                            aria-hidden="true"></i></td>
                                                            @else
                                                                <td scope="row" class="inactive">{{$department->name}} - {{$department->pivot->status}}<i class="fa fa-calendar" aria-hidden="true"></i></td>
                                                            @endif

                                                            @if($department->name == "DORADA")
                                                                 <td scope="row" class="active">{{$department->name}} - {{$department->pivot->status}}<i class="fa fa-calendar"
                                                            aria-hidden="true"></i></td>
                                                            @else
                                                                <td scope="row" class="inactive">{{$department->name}} - {{$department->pivot->status}}<i class="fa fa-calendar" aria-hidden="true"></i></td>
