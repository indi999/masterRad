                            ...
                            <table class="table">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <td scope="col">Brend</td>
                                        <td scope="col">Klijent</td>
                                        <td scope="col">Prodaja</td>
                                        <td scope="col">Opis posla</td>
                                        <td scope="col">Planirani završetak</td>
                                        <td scope="col">Očekivani završetak</td>
