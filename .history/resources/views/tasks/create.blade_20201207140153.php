                ...
                <div class="col-7">
                    ...
                    <div class="menu-items">
                        <ul>
                            ...
                            <li><a href="/jobs"><i class="fa fa-list" aria-hidden="true"></i>Lista poslova</a></li>
                            <li class="{{ route('jobs.index') }}"><a href="#"><i class="fa fa-plus" aria-hidden="true"></i>Dodaj posao</a></li>
                        </ul>
                    </div>
