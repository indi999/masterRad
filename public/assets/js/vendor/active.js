...
/*====== slick slider ======*/
    ...
    /* load more items */
    $(".bookPages .col-md-4, .allBooks .col-md-3").slice(0, 9).show();
    $(".load-more").on('click', function (e) {
        e.preventDefault();
        $(".bookPages .col-md-4:hidden, .allBooks .col-md-3:hidden").slice(0, 3).show();
        if ($(".bookPages .col-md-4:hidden, .allBooks .col-md-3:hidden").length == 0) {
            $(".load-more").hide('slow');
        }
    });

    const showMore = $('.showFields');
